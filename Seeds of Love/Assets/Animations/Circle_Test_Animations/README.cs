...
public class README{
     ...
     * so it will be in the same spot everytime. :(
     * 
     ...
     * 5. Move object to intial position, press the Keyframe button (Looks like a + and a diamond)
     ...
     * 10. Follow these ten commendments, and you will be a basic animator.
     */
}
